...
mindis = tc.define(lang, "mindis")
reduce_codes = tc.define(lang, "reduce_codes")
min_2d = tc.define(lang, "min_2d")
argmin_2d = tc.define(lang, "argmin_2d")

mindis.compile(luts_t, codes_t, mapping_options='naive')
S, v, min_idx = mindis(luts_t, codes_t)
print("minval: {} minidx: {}".format(v, min_idx))

reduce_codes.compile(luts_t, codes_t, mapping_options='naive')
S, = reduce_codes(luts_t, codes_t)

min_2d.compile(S, mapping_options='naive')
v, = min_2d(S)

argmin_2d.compile(S, v, mapping_options='naive')
...
reduce_codes = tc.define(lang, "reduce_codes")
min_2d = tc.define(lang, "min_2d")
min_1d = tc.define(lang, "min_1d")
argmin_2d = tc.define(lang, "argmin_2d")
argmin_1d = tc.define(lang, "argmin_1d")

reduce_codes.compile(luts_t, codes_t, mapping_options='naive')
S, = reduce_codes(luts_t, codes_t)

min_2d.compile(S.view((D, N / D)), mapping_options='naive')
V, = min_2d(S.view((D, N / D)))

min_1d.compile(V, mapping_options='naive')
v, = min_1d(V)

argmin_2d.compile(S.view((D, N / D)), v, mapping_options='naive')
MinIdx, = argmin_2d(S.view((D, N / D)), v)

argmin_1d.compile(S, MinIdx, mapping_options='naive')
...
min_2d.compile(S.view((K, D, N / D)), mapping_options='naive')
V2, = min_2d(S.view((K, D, N / D)))

min_1d.compile(V2, mapping_options='naive')
V, = min_1d(V2)

argmin_2d.compile(S.view((K, D, N / D)), V, mapping_options='naive')
MinIdx2, = argmin_2d(S.view((K, D, N / D)), V)

argmin_1d.compile(S, MinIdx2, mapping_options='naive')
